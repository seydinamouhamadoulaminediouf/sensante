...
# Etape 4.1 : Entraîner le modèle (5 lignes!)
...
# L'IA cherche ici les patterns entre X_train et y_train
...
#Étape 5.4 : (Optionnel) Visualiser la matrice de confusion
...
plt.close()  # Ferme sans bloquer, pas besoin de plt.show() dans un script
...
#Étape7.1:Recharger lemodèledepuisle chier
import joblib
...
#Étape7.2:Prédirepourunnouveaupatient(simulation)
...
# On utilise les objets rechargés depuis le disque pour garantir la cohérence
sexe_enc = le_sexe_loaded.transform([nouveau_patient['sexe']])[0]
region_enc = le_region_loaded.transform([nouveau_patient['region']])[0]

# 2. Preparer le vecteur de features (L'ordre doit être identique à l'entraînement !)
features = [
    nouveau_patient['age'],
    sexe_enc,
...
patients_test = [
    ...
    },
    {
        ...
        'tension_sys': 105, 'toux': True,
        'fatigue': True, 'maux_tete': True, 'region': 'Thiès'
    },
    {
        'nom': 'Patient âgé avec toux',
        'age': 68, 'sexe': 'M', 'temperature': 38.5,
        'tension_sys': 145, 'toux': True,
        'fatigue': True, 'maux_tete': False, 'region': 'Diourbel'
    },
]
